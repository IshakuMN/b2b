    ...
    <div className="max-w-4xl mx-auto relative">
      ...
      <div className="flex items-cente justify-center w-full border space-x-6 my-10 ">
        ...
        <h2 className="font-medium">
          {" "}
          <p className="text-3xl">НАДЁЖНОСТЬ</p>
          <p className="text-lg">И ОТВЕТСТВЕННОСТЬ</p>
        </h2>
      </div>
      <div className="flex  items-center border justify-between">
        {" "}
        <div className="rounded-lg h-40 w-32 border overflow-hidden flex flex-col">
        ...
        <div className="rounded-lg h-[200px] w-44 border overflow-hidden flex flex-col">
          <div className="bg-customGrey pt-4 flex-shrink-0">
            <Image
