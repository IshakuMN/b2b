...
const Hero = () => {
    ...
    return (
        <div className="flex mx-auto my-8 max-w-4xl max-lg:px-6 max-[700px]:px-4 max-[700px]:flex-col">
            ...
            <div className="relative max-[700px]:mx-0">
                ...
                <div
                    className="bg-customGreyEight absolute z-20 top-[40%]  -mt-8 -left-8 w-[400px] rounded-[20px] p-4 flex flex-col max-[700px]:relative max-[700px]:mx-auto max-[700px]:left-0 max-[450px]:w-[320px] max-[330px]:w-[280px]">
                    <div className="flex flex-col gap-4">
                        <div className="flex flex-row items-baseline gap-6 justify-between">
                            <p className="text-base font-medium text-black max-[700px]:text-sm">Рассчитать стоимость</p>
                            <div
                        ...
                        <div className="px-[10px] py-[5px] rounded-[10px] bg-white flex flex-col">
                            ...
                            <div className="my-3">
                                <Slider
                                    ...
                                    max={500000000}
                                    step={1}
                                    value={sliderValue} // Оставляем массив
                    ...
                    <div className="flex flex-col pt-4 ">
                        ...
                        <div className="flex flex-col">
                            <div className="flex flex-row justify-between items-center gap-2.5 max-[450px]:flex-wrap">
                                <p className="flex items-center justify-centerfont-medium  mr-4 text-sm max-sm:text-xs">Год</p>
                                <p
                                ...
                                <p
                                    className={`flex items-center justify-center text-xs rounded-[10px] px-2 py-1 ${activeYear === '2021' && inputYear.length === 0  ? 'text-white bg-customBlue' : 'bg-white'}`}
                                ...
                                <input
                                    type="text"
                                    className={`flex items-center justify-center text-xs rounded-[10px] px-2 py-1 border border-customBlue outline-none max-w-[60px] hover:border-customBlue hover:border-[1px] hover:border-solid ${inputYear.length === 4 ? 'text-white bg-customBlue' : 'bg-white text-black'}`}
                                    value={inputYear}
                                    onChange={(e) => {
                    ...
                    <span className="text-4xl font-normal">
                        {quarter === 1 ? 'Ⅰ' : quarter === 2 ? 'Ⅱ' : quarter === 3 ? 'Ⅲ' : 'Ⅳ'}
                            ...
                            <div className="flex flex-row justify-between items-center mt-5 gap-5">
                                ...
                                <div className="relative max-w-[291px]">
                                    <select
                                        id="material-select"
                                        value={selectedOption}
                                        onChange={handleSelectChange}
                                        className="w-full text-sm max-sm:text-xs border border-customBlue rounded-[5px] px-2 py-1 bg-white text-black outline-none pr-10 appearance-none"
                                    >
                                        <option value="">Строительные материалы</option>
